# Agent 3 test design report - C01_chronic_care_patient_journey
...
|---|---|---|---|---|---|
| unasked_reference | `condition_false` | inferred | PROVISIONAL | yes | f6de93712798f5f5 |
...
- D8 QUOTA_REGION:D1-O4 / full
- D8 QUOTA_REGION:D1-O5 / full

**`RANDOMIZATION_ANCHOR_UNDEFINED`** - 5 target(s)
